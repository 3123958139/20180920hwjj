...
if __name__ == '__main__':
    ...
    config['symbolpairs'] = {
        ...
        'BINA--EOS--BTC': 'BINA_SPOT_EOS_BTC',
        'BINA--XRP--BTC': 'BINA_SPOT_XRP_BTC',
        'BINA--ETC--BTC': 'BINA_SPOT_ETC_BTC',
        'BINA--ETH--BTC': 'BINA_SPOT_ETH_BTC',
        'BINA--BCC--BTC': 'BINA_SPOT_BCC_BTC',
        'BINA--LTC--BTC': 'BINA_SPOT_LTC_BTC',
        'OKEX--ETC--BTC': 'OKEX_SPOT_ETC_BTC',
        'OKEX--ETH--BTC': 'OKEX_SPOT_ETH_BTC',
        'OKEX--BCH--BTC': 'OKEX_SPOT_BCH_BTC',
        'OKEX--LTC--BTC': 'OKEX_SPOT_LTC_BTC',
        'OKEX--EOS--BTC': 'OKEX_SPOT_EOS_BTC',
        'OKEX--XRP--BTC': 'OKEX_SPOT_XRP_BTC',

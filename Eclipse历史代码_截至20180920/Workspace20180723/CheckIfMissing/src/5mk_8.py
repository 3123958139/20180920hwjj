...
if __name__ == '__main__':
    ...
    config = {
        ...
        'time': {  # time
            ...
            'end': '2018-08-21 08:00:00'
        },
        'symbolpairs':
        #     {
        #             'BINA--EOS--USDT': 'HUOBIPRO_SPOT_EOS_USDT',
        ...
        {  # BINA
            ...
            'BINA--BCC--USDT': 'BINANCE_SPOT_BCH_USDT',
            'BINA--LTC--USDT': 'BINANCE_SPOT_LTC_USDT',
            'BINA--EOS--BTC': 'BINANCE_SPOT_EOS_BTC',
            'BINA--XRP--BTC': 'BINANCE_SPOT_XRP_BTC',
            'BINA--ETC--BTC': 'BINANCE_SPOT_ETC_BTC',
            'BINA--ETH--BTC': 'BINANCE_SPOT_ETH_BTC',
            'BINA--BCC--BTC': 'BINANCE_SPOT_BCH_BTC',
            'BINA--LTC--BTC': 'BINANCE_SPOT_LTC_BTC'
        }
        #         {#BITFINEX
        #             'BINA--EOS--USDT': 'BITFINEX_SPOT_EOS_USD',
